        ...
        <section className="secao" id="contato">
            <div className="container contato">
                <div>
                    ...
                    <p><strong>Horário: </strong>Segunda a sábado, das 8h as 20h</p>
                ...
                <form className="formulario" onSubmit={enviarFormulario}>
                    ...
                    <textarea id="mensagem" rows="4" value={mensagem} onChange={(e) => setMensagem(e.target.value)} required placeholder="Digite sua mensagem aqui." />
