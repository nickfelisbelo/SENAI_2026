...
const { limiteInscricoes, inscricaoDuplicada, prazoCancelamento, promocao } = require("../services/inscricoes.services");
...
const atualizar = async (req, res) => {
    try {
        ...
        await prazoCancelamento(item.eventosId);
        await promocao(item.eventosId);
