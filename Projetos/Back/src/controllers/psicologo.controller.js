const service = require("../services/psicologo.services");
...
const listarPacientes = async (req,res)=>res.status(200).json(await service.listarPacientes(req.usuario));
module.exports = { cadastrar, listar, buscar, atualizar, excluir, listarPacientes };
